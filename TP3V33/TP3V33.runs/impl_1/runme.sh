...
HD_PWD='/home/lu/github/TP3V33/TP3V33.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bip.tcl -notrace
